create or replace FUNCTION FIND_A_HOTEL(I_STREET_NAME VARCHAR, I_CITY_NAME VARCHAR, I_STATE_CODE VARCHAR,I_ZIP_CODE VARCHAR ) RETURN INTEGER AS 
...
BEGIN
    ...
    RETURN V_HOTEL_ID;
     ...
     DBMS_OUTPUT.PUT_LINE('-- FIND_A_HOTEL SUCCESSFUL');
...
dbms_output.put_line('too many rows');
    ...
    WHEN OTHERS THEN
    DBMS_OUTPUT.PUT_LINE(SQLERRM);
    DBMS_OUTPUT.PUT_LINE('-- FIND_A_HOTEL - FAILED');
    RAISE;
END FIND_A_HOTEL;
